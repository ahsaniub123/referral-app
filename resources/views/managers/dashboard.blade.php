    ...
    <div class="col-12">
        ...
        <div class="row">
            ...
            @else
                ...
                <div class="col-md-12">
                    <div class="alert">
                        <span class="alert-title">Please share your referral link <span class="text-primary text-decoration-underline">{{ route('register') }}?ref={{ $user->referral_token }}</span> with others in order to earn wallet credit</span>
                    </div>
                </div>
